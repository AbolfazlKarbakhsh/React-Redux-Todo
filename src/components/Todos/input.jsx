...
import { TodoADD, TodoTRASH } from '../../Redux/Todo/todo-action';
                        ...
                        <div className='Todo-Task card mt-3 unload' key={Math.random() * 1000}>
                            <div className='card-body Todo-Task px-4 d-flex justify-content-between'>
                                <div className='d-flex align-items-center position-relative'>
                                    <div className={`rounded-circle circle-todo px-2 ${item.taskState && 'onInputChange'}`} onClick={handelColorInput}></div>
